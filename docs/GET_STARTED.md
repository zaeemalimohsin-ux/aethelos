...
**Current release:** v0.2.6.1 ([latest release](https://github.com/zaeemalimohsin-ux/aethelos/releases/latest))  
...
Keep your PC on while others join. Your temporary public address may change when you restart the app.
