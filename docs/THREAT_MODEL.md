...
| Client-side abuse / spam | **Relay-only** rate and size limits; client outbox capped at 500 with queue-full UX; social resolution (expulsion) remains the backstop. |
